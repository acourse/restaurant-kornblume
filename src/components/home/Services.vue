<template>
  <div class="py-24 md:py-40">
    <div class="sm:container px-4 mx-auto">
      <BaseHeader description="Unser Restaurant befindet sich direkt im Haus das Kristallhotel FETTEHENNE. Hier erwartet Sie ein freundliches Ambiente, herzlicher Service und eine gesunde, ausgewogene Küche." title="Unser Restaurant"/>
        ...
        <div class="w-full lg:w-1/3 px-4 pb-20 lg:pb-0 mb-16 lg:mb-0 relative">
          ...
          <div class="max-w-sm mx-auto text-center">
            ...
            <div class="mt-8">
              ...
              <div class="max-w-xs px-10 mx-auto">
                <p class="font-light text-gray-500">Hochzeit, Geburtstag, Trauerfeier oder privates Event geplant? In unserem Restaurant veranstalten wir gerne jede Art von Event und verpflegen mit leckeren Speisen, Snacks und Getränken.</p>
              </div>
            </div>
          </div>
        </div>
        <div class="w-full lg:w-1/3 px-4">
          <div class="max-w-sm mx-auto text-center">
            ...
            <div class="mt-8">
              ...
              <div class="max-w-xs px-10 mx-auto">
                <p class="font-light text-gray-500">Kölsch? Grauburgunder? Latte Macchiato?  An unserer Bar findest du nicht nur eine tolle Auswahl an Getränken, sondern auch Gleichgesinnte welche sich gerne an unserer Bar aufhalten. </p>
              </div>
            </div>
          </div>
        </div>
...
<script setup>
import BaseHeader from "../reusable/BaseHeader.vue";
